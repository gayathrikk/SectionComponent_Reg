	...
	private WebDriverWait wait;
		...
		@BeforeTest
		 ...
		 System.out.println("************************Login validation done***********************");
			...
			Thread.sleep(5000);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//span[text()='1045'])[1]"))).click();
			}
			...
			WebElement hdIcon = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@title='View High Resolution Image']")));
		
			if (hdIcon != null && hdIcon.isDisplayed()) {
		
			hdIcon.click();
		
			System.out.println("High Resolution Image icon clicked successfully");
		
			} else {
		
			System.out.println("High Resolution Image icon is not clicked");
			...
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//option[@value='87']"))).click();
			...
			Thread.sleep(3000);
			String[] expectedFileName = {"B_58_MTB15-SL_30-ST_NISL-SE_87_compressed.jp2"}; 
		
			java.util.List<WebElement> locationElements = driver.findElements(By.xpath("(//div[@class='paragraph'])[4]"));
			...
			System.out.println("Image loaded statement.");
			...
			System.out.println("***********************section component valdation done**************************");
